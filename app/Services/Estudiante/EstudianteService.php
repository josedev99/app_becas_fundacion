...
class EstudianteService{
    ...
    public function getDatosEstudianteTabla(){
        ...
        foreach ($datos as $row) {
            ...
            <button onclick="genExpediente(this)" data-record_id="'. encrypt($row->id) .'" data-nombre="'.ucwords(strtolower($row->nombre_completo)).'" title="Documento pdf - expediente" class="btn btn-outline-danger btn-sm" style="border:none;font-size:18px"><i class="bi bi-file-earmark-pdf"></i></button>
