   ...
   /**
    ...
    public function rules(): array
    {
        return [
            ...
            'monto_beca'    => ['required', 'numeric', 'min:0'],
    ...
    public function messages(): array
    {
        return [
            ...
            'monto_beca.required'     => 'El monto asignado es obligatorio.',
            'monto_beca.numeric'      => 'El monto asignado debe ser un número válido.',
            'monto_beca.min'          => 'El monto asignado no puede ser negativo.',
