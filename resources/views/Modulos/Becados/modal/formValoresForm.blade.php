    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body p-1">
                <form id="form-val-dinamico" method="post">
                    <div class="card p-1 m-0">
                        <div class="card-body p-1">
                            <div class="row">
                                <div class="col-sm-12 col-md-12 col-lg-12">
                                    <div class="content-input mb-2">
                                        <input type="text" name="nombre_dinamico" id="nombre_dinamico" placeholder=" "
                                            class="input">
                        ...
                        <div class="card-footer p-1 d-flex justify-content-end">
                            <button type="submit" class="btn btn-outline-success btn-sm" id="btnSaveInst"><i class="bi bi-person-add"></i> Guardar</button>
                        </div>
                    </div>
                </form>
            </div>
