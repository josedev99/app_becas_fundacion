                            ...
                            <div class="tab-content pt-2" id="borderedTabJustifiedContent">
                                <div class="tab-pane fade active show" id="bordered-justified-personal" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-4 col-lg-3">
                                            <div class="content-input mb-2">
                                                <input type="text" name="email_becado" id="email_becado" placeholder=" "
                                                    class="input">
                                ...
                                <div class="tab-pane fade" id="bordered-justified-academicos" role="tabpanel" aria-labelledby="academicos-tab">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-3">
                                            <div class="content-input mb-2">
                                                <input type="number" step="0.01" min="1" max="10" name="promedio" id="promedio" placeholder=" "
                                                    class="input">
                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-3">
                                            <div class="content-input mb-2">
                                                <input type="date" name="fInicio_beca" id="fInicio_beca" placeholder=" "
                                                    class="input">
                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-3">
                                            <div class="content-input mb-2">
                                                <input type="date" name="fFin_beca" id="fFin_beca" placeholder=" "
                                                    class="input">
                                ...
                                <div class="tab-pane fade" id="bordered-justified-socioeconomico" role="tabpanel" aria-labelledby="socioeconomico-tab">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-3">
                                            <div class="content-input mb-2">
                                                <input type="number" step="0.01" name="ingreso_aprox" id="ingreso_aprox" placeholder=" "
                                                    class="input">
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-3">
                                            <div class="content-input mb-2">
                                                <input type="text" name="numero_personas" id="numero_personas" placeholder=" "
                                                    class="input">
                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-6">
                                            <div class="content-input mb-2">
                                                <input type="text" name="necesidades_esp" id="necesidades_esp" placeholder=" "
                                                    class="input">
                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-6">
                                            <div class="content-input mb-2">
                                                <input type="text" name="comunidad_residencia" id="comunidad_residencia" placeholder=" "
                                                    class="input">
